            ...
            <li>
                <a href="/detail.php?id=<?=$article['id']?>">
                    <div class="article-list-det">
                        ...
                        <div class="title-box">
                            <span class="title-text" style="font-size:18px; font-weight:500; color:#5a5a5a; padding-top:8px;"><?=$article['title']?></span>
                            <span class="contents-text" style="font-size:8px; font-weight:200; color:#5a5a5a; padding-top:3px; padding-left:17px;">내용 미리보기</span>
                            <span class="date-text" style="font-size:8px; font-weight:200; color:#9e9e9e; text-align:right; padding-right:15px;"><?=$article['regDate']?></span>
                        </div>
                    </div>
                </a>
            </li>
                    ...
                    <div class="relative">
                        <div style="padding-left:30px; padding-top:18px;">
                            ...
                            <div class="flex mb-contents-text-s" style="font-size:7px; color:#9E9E9E;">
                                <span style="color:#FF5959;"><?=$cateItemName?></span>
